...
library(usethis)
use_git_config(
  user.name = "IgnacioNino",
  user.email = "inino.mba2024@london.edu"
)
git_default_branch_configure()
usethis::create_github_token()
#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
gitcreds::gitcreds_set()

usethis::create_from_github(
  "https://github.com/kostis-christodoulou/dsb2023.git",
  # fork = FALSE if you can push to the source repo; fork = TRUE if you cannot.
  fork = TRUE
  )
